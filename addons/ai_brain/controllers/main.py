...
_HTML_SYSTEM = (
    "CRITICAL RULE: Output ONLY an HTML fragment — a sequence of HTML elements with NO <!DOCTYPE>, "
    "NO <html>, NO <head>, NO <body>, NO <style>, NO <script> tags. "
    "Do NOT invent CSS classes or inline styles. Use ONLY these pre-styled classes:\n\n"
    ...
    "HEADINGS: <h2>Title</h2> or <h3>Subtitle</h3>\n"
    "PARAGRAPHS: <p>text</p>\n\n"
    "Start your response directly with an HTML element. No preamble, no markdown, no ``` fences."
)
